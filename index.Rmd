...
A draft of what has been a practical system to living **in the age of entropy** made explicit by Fanli (Christian) Zheng and Haohan Wang. 

It will include our daily practices which can be followed live here, and our diets which will include different types of consumption including social media (information diet), books/articles (knowledge diet),as well as food.


As you read, consider that whatever you first think, is likely to be wrong, since you may have not pushed yourself far enough to the edge to see what it would make of you, so we provide a 3 month plan that would allow you to 
